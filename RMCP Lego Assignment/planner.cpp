...
{
  //Definition of the robot, the given example correspond to the image at the assignment guidelines
  Joint j1(Joint::RotZ); 
  ...
  //This works adding to each joint the link (segment) to the next joint
  //Considering the first joint at the world frame
